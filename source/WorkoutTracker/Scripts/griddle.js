	...
	*/
	...
	var CustomPaginationContainer = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(that.props.customPagerComponent, { length: this.props.length, maxPage: this.props.maxPage, nextText: this.props.nextText, previousText: this.props.previousText, currentPage: this.props.currentPage, setPage: this.props.setPage, previous: this.props.previous, next: this.props.next });
	  }
	});
